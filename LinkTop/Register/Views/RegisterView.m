...
- (void)dealloc {
    ...
    ((UIImageView *)self.pwdTField.leftView).image = nil;
    [self.pwdTField removeAllSubviews];
    self.pwdTField = nil;
...
- (void)reloadViews {
    ...
    self.pwdTField.layer.cornerRadius = 4;
    self.pwdTField.borderStyle = 0;
    self.pwdTField.tag = 113;
    self.pwdTField.layer.borderWidth = 0.5;
    self.pwdTField.layer.borderColor = (__bridge CGColorRef)([UIColor cyanColor]);
    self.pwdTField.backgroundColor = UIColorHex(#ffffff);
    [self.pwdTField.layer setLayerShadow:shadowColor offset:shadowOffset radius:4];
    
    self.pwdTField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageWithMName:@"pwd_icon"]];
    self.pwdTField.leftViewMode = UITextFieldViewModeAlways;
    self.pwdTField.secureTextEntry = YES;
    
    
    shadowColor = [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:0.3];
    self.registerBtn.layer.cornerRadius = 4;
    self.registerBtn.layer.borderWidth = 0.5;
    self.registerBtn.layer.borderColor = (__bridge CGColorRef)([UIColor colorWithWhite:1 alpha:0.6]);
    [self.registerBtn.layer setLayerShadow:shadowColor offset:shadowOffset radius:4];
...
- (void)resignAllTextField {
    ...
    [self.pwdTField resignFirstResponder];
}
